...
- **Notes**: Notion-like light UI; full-width editor; collapsible **Notes + AI** side panel; UI prefs in localStorage; `/games/notes` alias; Supabase table **`uvimco_note_sessions`** live; AI lookup **`?term` + space/Enter** with model fallback on 503; **`npm run test:e2e:uvimco-lookup`** + sync/visual deploy E2E.
