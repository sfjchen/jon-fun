...
- **Pear Navigator demo polish**: Tap-to-advance primary (Skip step secondary); wrong-tap toast; Previous step; hero subtitle; step count badges; task-complete animation; PearPad tablet frame; stronger highlight; hints on all steps; home page apps updated to Procreate/Notion/Figma
