...
- **UVIMCO Notes**: Notion-like light theme (high-contrast `#37352f` on white), **Meetings** left sidebar (one page per meeting), CodeMirror editor, streaming AI panel, Ctrl shortcuts, localStorage + Supabase sync; E2E [`e2e/uvimco-notes.spec.ts`](e2e/uvimco-notes.spec.ts).
