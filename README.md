...
- **Veridian whiteboard deploy**: Standalone Vercel project `veridian-whiteboard` at [veridian-whiteboard.vercel.app](https://veridian-whiteboard.vercel.app) (custom domain `veridian.sfjc.dev` pending Cloudflare DNS). Repo [`sfjchen/veridian-whiteboard`](https://github.com/sfjchen/veridian-whiteboard); nested app uses OpenRouter only.
