...
- **Single public theme + home grid** (2026-05; **partially reverted 2026-06**): Removed theme switcher; home is notebook-only at `/`. **`/theme2` was later restored** for Connections mirror + visual E2E — see [`docs/ARCHITECTURE-MAP.md`](docs/ARCHITECTURE-MAP.md).
...
- **Notes agent docs + 3-cycle verify (2026-06-23)**: [`docs/NOTES-AGENT.md`](docs/NOTES-AGENT.md) for agents; README **🤖 AI agents — start here**; E2E hardening (`waitForNotesEditor` reload retry, meeting-title test fix); `npm run build` lint clean.
