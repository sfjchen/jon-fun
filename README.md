...
- **Pear Navigator simulator layout fix**: Revert scale-to-fill to scale-to-fit (contain) to prevent cutoff on narrow/wide displays; export dropdown only after settings tap
