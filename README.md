...
- **Notes** (`/games/uvimco-notes`): Shorthand note-taking with `?term` AI lookups; full-width editor; **Notes + AI** in collapsible right panel (panel hidden by default); localStorage + Supabase sync; admin at `/admin/uvimco-notes`
...
- **Notes**: Notion-like light UI; full-width editor; collapsible **Notes + AI** side panel; **`npm run test:e2e:uvimco-visual`** after UI changes (deployed sfjc.dev).
