...
- **Notes** (`/games/notes`): Long-term **personal knowledge vault** — domain packs (UVIMCO default, portfolio quant, CFA L1); auto-sectioning; `line?`/`??` AI; search/sync/glossary/sources. See **`docs/NOTES-KNOWLEDGE.md`**. Internal paths still `uvimco-notes` (legacy).
