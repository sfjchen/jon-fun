...
- **Veridian whiteboard deploy**: Standalone Vercel origin proxied at **[sfjc.dev/veridian](https://sfjc.dev/veridian)** (same path pattern as other projects — no subdomain DNS). Repo [`sfjchen/veridian-whiteboard`](https://github.com/sfjchen/veridian-whiteboard).
