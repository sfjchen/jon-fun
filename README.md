...
- **Notes** (`/games/notes`): Long-term **personal knowledge vault** — domain packs (UVIMCO default, portfolio quant, CFA L1); auto-sectioning; `line?`/`??` AI; search/sync/glossary/sources/RAG. See **`docs/NOTES-KNOWLEDGE.md`** and **`docs/NOTES-DESIGN.md`** (E2E matrix).
