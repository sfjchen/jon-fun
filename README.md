...
- **Two public faces:** **Notebook** (`/`)—handwritten **Patrick Hand** (medium stroke vs thin AD / heavy Kalam), cream line-paper, Stanford-adjacent red accent. **Ink & Paper** (`/theme2`)—Lora + Charter, cream + burgundy. Game-specific skins (Poker felt, Pear Navigator dark) are **allowed exceptions** where they aid the metaphor.
...
- **Notebook font (third pass)**: **Architects Daughter** → **Patrick Hand** for a **thicker** stroke while staying less slanted/clumpy than Kalam; tracking **~0.022em**, line-height **1.6**.
