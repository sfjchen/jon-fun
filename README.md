...
- **Notes**: Notion-like light UI; full-width editor; collapsible **Notes + AI** side panel; UI prefs in localStorage; `/games/notes` alias; **`npm run test:e2e:uvimco-visual`** after UI changes (deployed sfjc.dev).
