...
- **Notes platform evolution (Phase 1–3)**: New trigger grammar (`?` / `??`, no `?term`); **GlobalSearch**; **SyncPanel** + `restoreFromServer`; tags/metadata; **react-markdown** AI panel; autoglossary + cross-note todo rollup; resizable panel; **Sources** memory bank (local + Supabase); context assembler; **Summarize** rename; Tiptap behind **`NEXT_PUBLIC_NOTES_WYSIWYG=1`**; migration **`20260623120000_notes_memory.sql`**; **`docs/NOTES-DESIGN.md`**.
