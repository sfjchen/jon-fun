...
function wrapSelection(view: import('@codemirror/view').EditorView, before: string, after: string) {
...
function prefixLine(view: import('@codemirror/view').EditorView, prefix: string) {
...
export default function NoteEditor({
  ...
  const extensions = useMemo((): Extension[] => {
    const docsKeymap = keymap.of([
      ...
      {
        key: 'Mod-u',
        run: (view) => wrapSelection(view, '__', '__'),
      },
      {
        key: 'Mod-Shift-7',
