  ...
  if (!touchOk) {
    return (
      <div className="flex flex-col items-center justify-center p-6">
        <div className={`rounded-lg p-8 border max-w-md text-center shadow-sm ${linePaper ? 'bg-transparent' : ''}`} style={linePaper ? { borderColor: 'var(--ink-border)' } : { backgroundColor: 'var(--ink-paper)', borderColor: 'var(--ink-border)' }}>
