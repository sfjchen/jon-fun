...
const items = [
  ...
  { id: 'pear-navigator', title: 'Pear Navigator', description: 'Step-by-step guide with AI-style highlight overlay for creative apps (Procreate, Notion, Figma)', icon: '🍐', href: '/games/pear-navigator', available: true },
